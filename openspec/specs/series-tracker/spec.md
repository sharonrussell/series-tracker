...
The system SHALL allow a user to create a new series entry with a title and initial status.

#### Scenario: Add active series
- **WHEN** a user enters a title and saves the series
- **THEN** the system creates a new series record and shows it in the active series list
